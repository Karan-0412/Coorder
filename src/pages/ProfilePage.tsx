...
const cardCls = 'bg-surface-container-lowest rounded-xl border border-outline-variant/30';
    ...
    <div className="min-h-screen bg-background text-on-surface transition-colors duration-300">
      ...
      <main className="max-w-[800px] mx-auto px-margin-mobile md:px-margin-desktop py-8 mb-24 grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="md:col-span-1 space-y-6">
          ...
          <div className="glass-card rounded-2xl p-6 text-center shadow-sm relative overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <div className="w-24 h-24 mx-auto rounded-full p-1 bg-white shadow-sm mb-4">
                ...
                <img alt="Sarah Chen" className="w-full h-full rounded-full object-cover" src={imageUrls.profileAvatar} />
          ...
          <div className={`${cardCls} rounded-2xl shadow-sm overflow-hidden`}>
            ...
            {[
              ...
              <button
                ...
                className={`w-full flex items-center justify-between p-4 hover:bg-surface-container transition-colors text-left ${i < arr.length - 1 ? 'border-b border-outline-variant/10' : ''}`}
        ...
        <div className="md:col-span-2 space-y-6">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
            ...
            {profileStats.map((stat) => (
              ...
              <div key={stat.label} className={`${cardCls} rounded-xl p-4 text-center shadow-sm hover:-translate-y-1 transition-transform`}>
          ...
          {/* Wallet Card — always colorful, no dark change needed */}
          ...
          <div className="bg-gradient-to-br from-primary to-[#FF6B3D] rounded-2xl p-6 text-white shadow-lg relative overflow-hidden">
            ...
            <div className="relative z-10 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
              ...
              <div>
                ...
                <h2 className="text-4xl font-black tracking-tight mb-2">$389.00</h2>
          ...
          <div className={`${cardCls} rounded-2xl shadow-sm p-6`}>
            ...
            <div className="space-y-4">
              ...
              {recentPurchases.map((purchase) => (
                ...
                <div
                  ...
                  className="flex flex-col sm:flex-row sm:items-center justify-between p-4 bg-surface rounded-xl border border-outline-variant/20 hover:border-primary/30 transition-colors gap-3"
                ...
                >
                  ...
                  <div className="flex flex-row sm:flex-col items-center sm:items-end justify-between sm:justify-center">
                    ...
                    <p className="font-headline-md text-headline-md">{purchase.price}</p>
